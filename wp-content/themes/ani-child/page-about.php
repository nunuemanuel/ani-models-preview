...
<div class="ani-about-page">
	...
	<!-- ========================================================= SECTION 5: EQUIPMENT & TECHNOLOGIES -->
	<section class="section ani-about-tech" aria-labelledby="about-tech-title">
		<div class="ani-container">

			<h2 class="section-title section-title--center" id="about-tech-title">
				<?php esc_html_e( 'הציוד והטכנולוגיות שלנו', 'ani' ); ?>
			</h2>
			<p class="ani-about-tech__intro">
				<?php esc_html_e( 'הציוד שלנו הוא ההוכחה — מכונות תעשייתיות אמיתיות ומוכחות בפרויקטים מורכבים.', 'ani' ); ?>
			</p>

			<div class="ani-about-tech__grid">

				<!-- 3D Printing category -->
				<div class="ani-tech-card">
					<h3 class="ani-tech-card__cat">
					...
					<ul class="ani-tech-card__list">
						<li>
							<span class="ani-tech-name" dir="ltr">FlashForge Creator 4S</span>
							<span class="ani-tech-spec"><?php esc_html_e( 'FDM — פולימרים הנדסיים', 'ani' ); ?></span>
						</li>
						<li>
							<span class="ani-tech-name" dir="ltr">Sintratec S2</span>
							<span class="ani-tech-spec"><?php esc_html_e( 'SLS — ניילון ופולימרים', 'ani' ); ?></span>
						</li>
						<li>
							<span class="ani-tech-name" dir="ltr">Sonic Mega V2</span>
							<span class="ani-tech-spec"><?php esc_html_e( 'SLA (resin) — רזולוציה גבוהה', 'ani' ); ?></span>
						</li>
						<li>
							<span class="ani-tech-name" dir="ltr">Formlabs Fuse</span>
							<span class="ani-tech-spec"><?php esc_html_e( 'SLS תעשייתי', 'ani' ); ?></span>
						</li>
					</ul>
				</div><!-- .ani-tech-card -->

				<!-- CNC + Scanning category -->
				<div class="ani-tech-card">
					<h3 class="ani-tech-card__cat">
						<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true" focusable="false">
						...
						<?php esc_html_e( 'עיבוד שבבי וסריקה', 'ani' ); ?>
					</h3>
					<ul class="ani-tech-card__list">
						<li>
							<span class="ani-tech-name"><?php esc_html_e( 'מרכזי עיבוד CNC', 'ani' ); ?></span>
							<span class="ani-tech-spec"><?php esc_html_e( '3/4/5 צירים — אלומיניום, פלדה, טיטניום, פלסטיקים', 'ani' ); ?></span>
						</li>
						<li>
							<span class="ani-tech-name"><?php esc_html_e( 'סורקים תעשייתיים', 'ani' ); ?></span>
							<span class="ani-tech-spec"><?php esc_html_e( 'הנדסה לאחור, בקרת איכות, CMM מטרולוגיה', 'ani' ); ?></span>
						</li>
					</ul>
				</div><!-- .ani-tech-card -->

				<!-- Finishing + QC category -->
				<div class="ani-tech-card">
					<h3 class="ani-tech-card__cat">
						<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true" focusable="false">
							<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
						</svg>
						<?php esc_html_e( 'גימור ובקרת איכות', 'ani' ); ?>
					</h3>
					<ul class="ani-tech-card__list">
						<li>
							<span class="ani-tech-name"><?php esc_html_e( 'עמדות גימור וניקוי', 'ani' ); ?></span>
							<span class="ani-tech-spec"><?php esc_html_e( 'ניקוי, חציץ (sandblasting), גימור שטח', 'ani' ); ?></span>
						</li>
						<li>
							<span class="ani-tech-name"><?php esc_html_e( 'עמדות בקרת איכות', 'ani' ); ?></span>
							<span class="ani-tech-spec"><?php esc_html_e( 'ציוד מדידה ובקרת איכות מקצועי', 'ani' ); ?></span>
						</li>
						<li>
							<span class="ani-tech-name"><?php esc_html_e( 'הרכבה ואינטגרציה', 'ani' ); ?></span>
							<span class="ani-tech-spec"><?php esc_html_e( 'הרכבות מכניות, אלקטרו-מכניות ואלקטרוניות', 'ani' ); ?></span>
						</li>
					</ul>
				</div><!-- .ani-tech-card -->

			</div><!-- .ani-about-tech__grid -->

		</div><!-- .ani-container -->
	</section><!-- .ani-about-tech -->
